...
<AltaActividad v-if="showAlta"/>
<BajaActividad v-if="showBaja"/>
<ModificacionActividad v-if="showModificacion"/>
<VisualizarActividad v-if="showVisualizar"/>
</div>
</template>

<script>
import AltaActividad from './AltaActividad.vue'
import BajaActividad from './BajaActividad.vue'
import ModificacionActividad from './ModificacionActividad.vue'
import VisualizarActividad from './VisualizarActividad.vue'
export default {
  name: 'ABMActividad',
  components: {
    AltaActividad,
