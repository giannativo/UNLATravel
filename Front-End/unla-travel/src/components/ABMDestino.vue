...
<div>
    ...
    <AltaDestino v-if="showAlta"/>
    <ModificacionDestino v-if="showModificacion"/>
    <BajaDestino v-if="showBaja"/>
    <VisualizarDestino v-if="showVisualizar"/>
</div>
</template>

<script>
import AltaDestino from './AltaDestino.vue'
import ModificacionDestino from './ModificacionDestino.vue'
import BajaDestino from './BajaDestino.vue'
import VisualizarDestino from './VisualizarDestino.vue'
